...
# MAGIC %sql
# MAGIC -- CREATE A CATALOG, SCHEMA AND VOLUME TO STORE DATA NEEDED FOR THIS
# MAGIC CREATE CATALOG IF NOT EXISTS ml_training_acs;
# MAGIC USE CATALOG ml_training_acs;
# MAGIC CREATE DATABASE IF NOT EXISTS ml_datasets_acs;
# MAGIC USE DATABASE ml_datasets_acs;
# MAGIC CREATE VOLUME IF NOT EXISTS ml_rawdata_acs;
...
# MAGIC %md 
# MAGIC ### Ignore the following section if you have permissions to create the Catalog and Volume as shown above
# MAGIC
# MAGIC Import data
# MAGIC   
# MAGIC In this section, you download a dataset from the web and upload it to Databricks File System (DBFS).
# MAGIC
# MAGIC 1. Navigate to https://archive.ics.uci.edu/dataset/186/wine+quality and download both `winequality-red.csv` and `winequality-white.csv` to your local machine.
# MAGIC
...
whitewine_path = "/Volumes/ml_training_acs/ml_datasets_acs/ml_rawdata_acs/winequality-white.csv"
redwine_path = "/Volumes/ml_training_acs/ml_datasets_acs/ml_rawdata_acs/winequality-red.csv"
